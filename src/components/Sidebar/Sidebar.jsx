          ...
          <ul className="Sidebar__navigation-list">
            <div className="nav-link-reset">
              <li className="Sidebar__navigation-item item--wrapper item--hover">
                <img
                  className="Sidebar__icon margin--no"
                  src={require("./assets/constructor.svg").default}
                  alt="course"
                />
                <p className="Sidebar__navigation-title item--text">Конструктор</p>
              </li>
            </div>
            <div className="nav-link-reset">
              <li className="Sidebar__navigation-item item--wrapper item--hover">
                <img
                  ...
                  alt="messages"
                />
                <p className="Sidebar__navigation-title item--text">Сообщения</p>
              </li>
            </div>
            <div className="nav-link-reset">
              <li className="Sidebar__navigation-item item--wrapper item--hover">
          ...
          <div className="Sidebar__bottom-wrapper">
            ...
            <ul className="Sidebar__bottom-list">
              ...
              >
                ...
                <p className="item--text">Настройки</p>
              </li>
              {localStorage.token && (
